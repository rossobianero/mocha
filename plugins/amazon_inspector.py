# Amazon Inspector plugin (SCA for cloud artifacts) — placeholder
...
class AmazonInspectorPlugin(ScannerPlugin):
    ...
    def scan(self, repo_dir, c):
        # In a real integration, use boto3 Inspector2 to fetch findings for ECR/Lambda/EC2
        fake = Finding(
            id="arn:aws:inspector2:us-east-1:acct:finding/fake",
            tool="amazon_inspector", kind="SCA", severity="critical",
            cwe=None, cve=["CVE-2025-0001"],
